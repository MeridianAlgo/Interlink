    ...
    >
      ...
      >
        ...
        >
          ...
          <h2 style={{ fontSize: "2rem", marginBottom: "1rem", color: "#fff" }}>
            InterLink Explorer &ndash; Coming Soon
          </h2>
          <p
            style={{
              color: "var(--text-2)",
          ...
          >
            Our real-time cross-chain message explorer is currently in
            development. We are processing alpha stage proofs. Stay tuned!
          </p>
        </div>
      </div>
      ...
      <div className="container">
        <div className="section-header" style={{ marginBottom: "3rem" }}>
          ...
          <h1 className="doc-title" style={{ fontSize: "2.5rem" }}>
            Network Transactions
          </h1>
          <p className="doc-lead" style={{ border: "none", padding: 0 }}>
            Real-time feed of cross-chain messages verified by InterLink.
          </p>
        </div>
