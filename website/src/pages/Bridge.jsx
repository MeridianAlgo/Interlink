      ...
      >
        ...
        >
          ...
          <h2 style={{ fontSize: "2rem", marginBottom: "1rem", color: "#fff" }}>
            InterLink Bridge &ndash; Coming Soon
          </h2>
          <p
            style={{
              color: "var(--text-2)",
          ...
          >
            Full cross-chain functionality is currently in development. Our O(1)
            Halo2 proofs and Solana execution hub are being finalized. Stay
            tuned!
          </p>
        </div>
      </div>
              ...
              >
                <div
                  style={{
                    ...
                    height: 20,
                    borderRadius: "50%",
                    background: step >= 1 ? "var(--green)" : "var(--bg-3)",
                    display: "flex",
                    alignItems: "center",
                    justifyContent: "center",
                  }}
                ...
                <span
                  style={{
                    fontSize: "0.85rem",
                    color: step >= 1 ? "#fff" : "var(--text-3)",
                  }}
                >
                  Confirming Source Finality
                </span>
                {step === 1 && (
              ...
              >
                <div
                  style={{
                    ...
                    height: 20,
                    borderRadius: "50%",
                    background: step >= 2 ? "var(--green)" : "var(--bg-3)",
                    display: "flex",
                    alignItems: "center",
                    justifyContent: "center",
                  }}
                ...
                <span
                  style={{
                    fontSize: "0.85rem",
                    color: step >= 2 ? "#fff" : "var(--text-3)",
                  }}
                >
                  Generating Halo2 SNARK
                </span>
                {step === 2 && (
                  <div className="pulse-dot" style={{ marginLeft: "auto" }} />
                )}
              ...
              >
                <div
                  style={{
                    ...
                    height: 20,
                    borderRadius: "50%",
                    background: step >= 3 ? "var(--green)" : "var(--bg-3)",
                    display: "flex",
                    alignItems: "center",
                    justifyContent: "center",
                  }}
                ...
                <span
                  style={{
                    fontSize: "0.85rem",
                    color: step >= 3 ? "#fff" : "var(--text-3)",
                  }}
                >
                  Verifying on Solana Hub
                </span>
                {step === 3 && (
                  <div className="pulse-dot" style={{ marginLeft: "auto" }} />
                )}
