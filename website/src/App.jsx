          ...
          <nav>
            ...
            <ul className="nav-links desktop-only">
              ...
              <li>
                <Link
                  to="/explorer"
                  className={path === "/explorer" ? "active" : ""}
                >
                  Explorer
                </Link>
              </li>
      ...
      <AnimatePresence>
        {open && (
          ...
          >
            ...
            <Link to="/bridge" onClick={() => setOpen(false)}>
              Bridge
            </Link>
            <Link to="/explorer" onClick={() => setOpen(false)}>
              Explorer
            </Link>
...
const App = () => (
  <Router>
    ...
    <footer
      className="footer"
      style={{ padding: "2rem 0", textAlign: "center", color: "var(--text-3)" }}
    >
      <div className="container">
        <p>© 2026 MeridianAlgo Research Lab · InterLink Protocol · v0.7.3</p>
      </div>
    </footer>
  </Router>
);
